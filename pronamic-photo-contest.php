	...
	public function init() {
		register_post_type( 'pronamic_photo_entry', array(
			'labels'             => array(
				...
				'menu_name'          => __( 'Photo Entries', 'pronamic_photo_contest' )
			) ,
			'public'             => true,
		...
		register_taxonomy( 'pronamic_photo_contest', 'pronamic_photo_entry', array(
			'hierarchical' => true ,
			'labels' => array(
				'name' => _x( 'Photo Contests', 'category general name', 'pronamic_photo_contest' ),
				'singular_name' => _x( 'Photo Contest', 'category singular name', 'pronamic_photo_contest' ),
				'search_items' => __( 'Search Photo Contests', 'pronamic_photo_contest' ),
				'all_items' => __( 'All Photo Contests', 'pronamic_photo_contest' ),
				'parent_item' => __( 'Parent Photo Contest', 'pronamic_photo_contest' ),
				'parent_item_colon' => __( 'Parent Photo Contest:', 'pronamic_photo_contest' ),
				'edit_item' => __( 'Edit Photo Contest', 'pronamic_photo_contest' ),
				'update_item' => __( 'Update Photo Contest', 'pronamic_photo_contest' ),
				'add_new_item' => __( 'Add New Photo Contest', 'pronamic_photo_contest' ),
				'new_item_name' => __( 'New Photo Contest Name', 'pronamic_photo_contest' ),
				'menu_name' => __( 'Photo Contests', 'pronamic_photo_contest' )
			),
			'show_ui' => true ,
			'query_var' => true ,
			'rewrite' => array( 'slug' => _x( 'photo-contest', 'URL slug', 'pronamic_photo_contest' ) ),
		) );
	}
}
